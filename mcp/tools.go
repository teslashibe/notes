// Package mcp owns the reusable Notes tool contract, not transport or application authority.
package mcp
...
// Tools returns fresh schemas, including all nested maps and slices.
...
// Decode validates the canonical contract before the application claims an operation.
